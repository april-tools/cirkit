...
import cirkit.symbolic.functional as STCF  # SymbolicTensorizedCircuit functional.
from cirkit.layers import DenseLayer, InputLayer, MixingLayer, ProductLayer, SumLayer
from cirkit.region_graph import PartitionNode, RegionGraph, RegionNode, RGNode
from cirkit.symbolic.symbolic_layer import (
    SymbolicInputLayer,
    SymbolicLayer,
