...
from .input import CategoricalProductPartitionLayer as CategoricalProductPartitionLayer
...
from .input import NormalProductPartitionLayer as NormalProductPartitionLayer
