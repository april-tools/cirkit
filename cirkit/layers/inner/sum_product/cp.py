...
from cirkit.layers.inner.product.hadamard import HadamardLayer
from cirkit.layers.inner.sum.dense import DenseLayer
from cirkit.layers.inner.sum_product.sum_product import SumProductLayer
