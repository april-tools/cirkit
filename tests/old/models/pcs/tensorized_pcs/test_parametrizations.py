...
from cirkit.old.models.functional import integrate
from cirkit.old.region_graph import RegionGraph
from cirkit.old.region_graph.poon_domingos import PoonDomingos
from cirkit.old.region_graph.quad_tree import QuadTree
from cirkit.old.region_graph.random_binary_tree import RandomBinaryTree
from cirkit.old.reparams.leaf import ReparamClamp, ReparamExp, ReparamSoftmax, ReparamSquare
from cirkit.old.utils import RandomCtx
from cirkit.old.utils.type_aliases import ReparamFactory
from tests import floats
from tests.old.models.pcs.tensorized_pcs.test_likelihoods import get_deep_pc
