...
def test_symbolic_layers_sum_and_prod() -> None:
    ...
    assert (
        ...
        "scope=Scope({0}), num_units=3, layer_cfg=SymbLayerCfg(layer_cls=<class 'cirkit.layers"
    ...
    assert (
        ...
        ".layers.inner.product.hadamard.HadamardLayer'>, layer_kwargs={}, reparam=None, "
    ...
    assert (
        ...
        ".layers.inner.sum.dense.DenseLayer'>, layer_kwargs={}, reparam=ExpReparam("
    )
...
def test_symbolic_layers_sum_prod() -> None:
    ...
    assert (
        ...
        ".layers.inner.sum_product.tucker.TuckerLayer'>, layer_kwargs={}, reparam=None, "
        "reparam_factory=None, symb_layer=SymbolicProductLayer@0x"
    ...
    assert (
        repr(sum_layer).splitlines()[0] == f"SymbolicSumLayer@0x{id(sum_layer):x}("
        "scope=Scope({0, 1}), arity=1, num_units=3, layer_cfg=SymbLayerCfg(layer_cls=<class 'cirkit"
        ".layers.inner.sum_product.tucker.TuckerLayer'>, layer_kwargs={}, reparam=ExpReparam("
    )
